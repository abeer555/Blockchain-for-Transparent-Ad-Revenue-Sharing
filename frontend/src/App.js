...
// Default contract address - Updated from latest deployment
...
function App() {
  ...
  const getUserRole = () => {
    ...
    if (account.toLowerCase() === contractInfo.company.toLowerCase())
      return "Company";
    if (account.toLowerCase() === contractInfo.platform.toLowerCase())
      return "Platform";
    if (account.toLowerCase() === contractInfo.creator.toLowerCase())
      return "Creator";
    return "Observer";
  };
      ...
      <div className="container">
          ...
          <div className="contract-info">
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                <label>Company:</label>
                <span>
                  {contractInfo.company.slice(0, 6)}...
                  {contractInfo.company.slice(-4)}
                </span>
              </div>
              <div className="info-item">
                <label>Platform:</label>
                <span>
                  {contractInfo.platform.slice(0, 6)}...
                  {contractInfo.platform.slice(-4)}
                </span>
              </div>
              <div className="info-item">
                <label>Creator:</label>
                <span>
                  {contractInfo.creator.slice(0, 6)}...
                  {contractInfo.creator.slice(-4)}
                </span>
              </div>
              <div className="info-item">
        ...
        {canDeposit() && (
          <div className="action-section">
            ...
            <p className="helper-text">
              Funds will be automatically split: {contractInfo?.platformShare}%
              to Platform, {contractInfo?.creatorShare}% to Creator
            </p>
          </div>
        )}
        ...
        {!canDeposit() && !canWithdraw() && (
          <div className="observer-section">
            ...
            <p>
              You can view the contract information and balances, but cannot
              perform transactions.
            </p>
            <p>
              Connect with the Company account to deposit funds, or
              Platform/Creator accounts to withdraw.
            </p>
          </div>
        )}
